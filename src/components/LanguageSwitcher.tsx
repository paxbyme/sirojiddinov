...
export function LanguageSwitcher() {
  ...
  return (
    <div ref={ref} className="fixed bottom-6 right-6 z-50">
      {open && (
        <div className="creme-card mb-2 p-1.5 shadow-xl">
      ...
      <button
        ...
        className="creme-card flex items-center gap-2 px-4 py-3 text-sm font-medium text-neutral-600 shadow-lg transition-all duration-500 hover:scale-[1.03] dark:text-neutral-400"
